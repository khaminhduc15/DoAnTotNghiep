...
function createPlaylist() {
    ...
    document.getElementById('background-show-song-playlist').style.display='none';
}
function createAlbums() {
    background_author.style.display="none";
    background_create_album.style.display="block";
    document.getElementById('background-show-song').style.display = 'none'
    dataSongAlbum(url)
}
...
function savePlaylist() {
    ...
    if (name == ""){
        alert("Please Enter Playlist Name To Add Songs!");
    }
    else {
        document.getElementById('background-show-song-playlist').style.display='block';
        dataSong(url);
